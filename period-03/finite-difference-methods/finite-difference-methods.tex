...
\begin{algorithm}[H]
\caption{Algorithm 4.2.1: Explicit Finite Difference for Black-Scholes}
\begin{algorithmic}[1]
...
\paragraph{Supporting Subroutines}

\begin{algorithm}[H]
\caption{Algorithm 4.2.2: Validate-Stability}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{Algorithm 4.2.3: Initialize-Grid}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{Algorithm 4.2.4: Set-Boundary-Conditions}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{Algorithm 4.2.5: Explicit-Update}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{Algorithm 4.2.6: Update-Boundary-Conditions}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{Algorithm 4.2.7: Interpolate-Value}
\begin{algorithmic}[1]
