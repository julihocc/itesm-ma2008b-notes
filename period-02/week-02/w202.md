...
A natural next step is to use a quadratic interpolation polynomial rather than a linear one.  
Assuming three approximations $x_0, x_1, x_2$ are in hand, derive a formula for a new approximation $x_3$, which is a root of such a quadratic.
